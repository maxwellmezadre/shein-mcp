...
**O jar de cookies é a conta inteira.** Quem tiver `session.enc` e a chave ao
lado dele consegue ler seu histórico de compras, seu endereço e seu CPF.
...
- Não aumente `SHEIN_MIN_INTERVAL_MS` para zero. O ritmo é o que evita o
  bloqueio anti-bot.
