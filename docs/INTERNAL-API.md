...
aqui é documentado ou estável; quando mudar, [`REDISCOVERY.md`](REDISCOVERY.md)
diz como remapear.
...
- `00101001`: é o que um chamador deslogado recebe, e também o que um
  parâmetro ou método errado recebe. É ambíguo, então não marca a sessão como
  morta: vira um erro de API com uma dica, e `auth_status` é quem classifica.
...
`00101001` e POST com `100102` em três formatos de parâmetro, e continua sem
